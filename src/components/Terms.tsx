  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      ...
      <div className="max-w-3xl text-left">
        ...
        <p className="mb-4">
          You agree not to engage in any activities that may harm the platform,
          its users, or violate any applicable laws. This includes, but is not
          limited to, unauthorized access, data scraping, or distributing
          malicious software.
        </p>
        ...
        <p className="mb-4">
          ...
          platform at our sole discretion, without notice, for conduct that we
        ...
        <p className="mb-4">
          ...
          of the platform after any changes constitutes your acceptance of the
          new terms.
        </p>
